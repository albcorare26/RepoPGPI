...
<div class="wrapper-info">
	...
	<div class="col-right">			
			<div style="text-align:center; font-weight:bold;">
				<hr />
				<a href="<?php echo SKT_LIVE_DEMO; ?>" target="_blank"><?php esc_html_e('Live Demo', 'skt-toothy'); ?></a> | 
				<a href="<?php echo SKT_PRO_THEME_URL; ?>"><?php esc_html_e('Buy Pro', 'skt-toothy'); ?></a> | 
				<a href="<?php echo SKT_THEME_DOC; ?>" target="_blank"><?php esc_html_e('Documentation', 'skt-toothy'); ?></a>
